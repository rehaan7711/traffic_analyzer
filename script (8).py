# Create the junction detector module
junction_detector_code = '''import cv2
import numpy as np
...
with open('junction_detector.py', 'w') as f:
    f.write(junction_detector_code)

print("junction_detector.py created successfully!")
print(f"File size: {len(junction_detector_code)} characters")